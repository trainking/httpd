...
httpd: $(OUT_PATH)/common.o $(OUT_PATH)/httpd.o $(OUT_PATH)/response.o $(OUT_PATH)/request.o
	$(CC) $(CFLAGS) $(OUT_PATH)/common.o $(OUT_PATH)/httpd.o $(OUT_PATH)/response.o $(OUT_PATH)/request.o -o $(BIN_PATH)/httpd $(LIBS)
